...
@section('content')
    <section id="Content" class="bg-portto-black flex min-h-screen">
        <div
            class="w-[660px] min-h-screen flex flex-col p-[30px_40px] justify-end overflow-hidden bg-[url('{{ asset('images/background/side-image.png') }}')] bg-cover bg-center bg-no-repeat">
        ...
        <div
            class="flex flex-col gap-[50px] items-center justify-center mx-auto py-4 bg-[url('{{ asset('images/Ellipse.svg') }}')] bg-center bg-no-repeat bg-contain bg-[length:540px]">
